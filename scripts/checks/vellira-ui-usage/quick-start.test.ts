...
const filePath = 'apps/website/src/sections/home/QuickStart/QuickStart.tsx';
...
describe('QuickStart canonical controls', () => {
  it('uses public bare Buttons without standard Button geometry', () => {
    for (const control of quickStartControls()) {
  ...
  it('detects reverting the controls to authored native buttons', () => {
    const tags = quickStartControls()
      .flatMap((control) => [
