...
const filePath = 'apps/website/src/blog/ui/BlogArticleActions.tsx';
...
function articleActionControls() {
...
describe('BlogArticleActions canonical action controls', () => {
  it('uses public bare Buttons without standard Button geometry', () => {
    for (const control of articleActionControls()) {
  ...
  it('detects reverting the action controls to authored native buttons', () => {
    const tags = articleActionControls()
      .flatMap((control) => [
