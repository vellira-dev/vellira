...
const filePath =
  'apps/website/src/component-catalog/shared/ComponentHeaderActions/ComponentHeaderActions.tsx';
...
function platformControl() {
  ...
  function visit(node: ts.Node) {
    if (
      ...
      node.getText(sourceFile).includes('styles.platformButton')
    ) {
...
describe('ComponentHeaderActions canonical platform control', () => {
  ...
  it('detects reverting the platform control to an authored native button', () => {
    const control = platformControl();
    const tags = [
