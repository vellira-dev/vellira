...
describe('semantic vocabulary consumer and Web identity completion', () => {
  it(
    'checks maintained production consumers and #883 Web identities without findings',
    () => {
  ...
  it(
    'fails closed when a production consumer revives a deprecated semantic role',
    () => {
