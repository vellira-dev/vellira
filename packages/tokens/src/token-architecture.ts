...
export const semanticVocabularyV1 = {
  surface: {
    purpose:
      'Layer and interaction backgrounds with explicit root, large-section, bounded-panel, and elevated ownership.',
    roles: [
      'canvas',
      'default',
      'section',
...
export const maintainedComponentFactories = [
  {
    ...
    source: 'packages/tokens/src/factories/components/createAccordionTokens.ts',
  ...
  },
  {
    ...
    source: 'packages/tokens/src/factories/components/createButtonTokens.ts',
    semanticAdapter: null,
    stateKeys: ['default', 'hover', 'pressed'],
  },
  {
    name: 'createCheckboxTokens',
    source: 'packages/tokens/src/factories/components/createCheckboxTokens.ts',
    semanticAdapter: null,
    stateKeys: ['default', 'hover', 'pressed'],
  },
  {
  ...
  },
  {
    ...
    source: 'packages/tokens/src/factories/components/createDropdownTokens.ts',
    semanticAdapter: null,
    stateKeys: ['default', 'hover', 'focus', 'active', 'pressed'],
  },
  {
    name: 'createFormFieldTokens',
    source: 'packages/tokens/src/factories/components/createFormFieldTokens.ts',
  ...
  },
  {
    ...
    source: 'packages/tokens/src/factories/components/createInputTokens.ts',
    semanticAdapter: null,
    stateKeys: ['default', 'hover', 'focus'],
  },
  {
    name: 'createModalTokens',
    source: 'packages/tokens/src/factories/components/createModalTokens.ts',
    semanticAdapter: 'createModalTokensFromSemantics',
    stateKeys: ['default', 'hover', 'pressed', 'focus', 'disabled'],
  },
  {
    name: 'createPopoverTokens',
    source: 'packages/tokens/src/factories/components/createPopoverTokens.ts',
  ...
  },
  {
    ...
    source: 'packages/tokens/src/factories/components/createRadioTokens.ts',
    semanticAdapter: null,
    stateKeys: ['default', 'hover', 'pressed'],
  },
  {
    name: 'createSelectTokens',
    source: 'packages/tokens/src/factories/components/createSelectTokens.ts',
    semanticAdapter: null,
    stateKeys: [
      'default',
      'hover',
  ...
  },
  {
    ...
    source: 'packages/tokens/src/factories/components/createSwitchTokens.ts',
