...
import pr1165AddPublicLaunchCrossPlatformTextareaMetadata from '../../content/blog/pr-1165-add-public-launch-cross-platform-textarea/metadata.json';
...
const blogArticleMetadataRegistryEntries = [
  ...
  {
    slug: 'pr-1165-add-public-launch-cross-platform-textarea',
    metadata: pr1165AddPublicLaunchCrossPlatformTextareaMetadata,
  },
  {
...
const blogArticleModuleLoaders: Readonly<Record<string, BlogMDXModuleLoader>> =
  {
    ...
    'pr-1165-add-public-launch-cross-platform-textarea': () =>
      import('../../content/blog/pr-1165-add-public-launch-cross-platform-textarea/article.mdx'),
