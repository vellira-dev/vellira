...
const reactRadioGroupApiSections: readonly ComponentApiSection[] = [
  {
    name: 'RadioGroup',
    props: [
      {
        name: 'name',
        type: 'string',
        description: 'Native radio group name shared by child radios.',
      },
      {
        name: 'label',
        type: 'ReactNode',
      ...
      },
      {
        name: 'description',
        type: 'ReactNode',
        description: 'Supporting text rendered with the group.',
      },
      {
        name: 'error',
        type: 'string',
      ...
      },
      {
        ...
        description: 'Selected color inherited by child radios.',
      },
      {
        name: 'value',
        type: 'string',
      ...
      },
      {
        ...
        type: "'sm' | 'md' | 'lg'",
        defaultValue: "'md'",
        description: 'Size inherited by child radios.',
      },
      {
        name: 'onValueChange',
...
const nativeRadioGroupApiSections: readonly ComponentApiSection[] = [
  {
    name: 'RadioGroup',
    props: [
      {
      ...
      },
      {
        name: 'itemsStyle',
        type: 'StyleProp<ViewStyle>',
        description: 'Style applied to the items container.',
      },
      {
        name: 'labelStyle',
        type: 'StyleProp<TextStyle>',
        description: 'Style applied to label text.',
      },
      {
        name: 'descriptionStyle',
        type: 'StyleProp<TextStyle>',
        description: 'Style applied to description text.',
      },
      {
        name: 'errorStyle',
        type: 'StyleProp<TextStyle>',
        description: 'Style applied to error text.',
      },
      {
        name: 'value',
        type: 'string',
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        name: 'error',
        type: 'string',
        description: 'Validation error rendered below the radio.',
      },
      {
        name: 'containerStyle',
        type: 'StyleProp<ViewStyle>',
        description: 'Extra style for the root container.',
      },
      {
        name: 'labelStyle',
        type: 'StyleProp<TextStyle>',
        description: 'Extra label text style.',
      },
      {
        name: 'descriptionStyle',
        type: 'StyleProp<TextStyle>',
      ...
      },
      {
        name: 'errorStyle',
        type: 'StyleProp<TextStyle>',
        description: 'Extra error text style.',
      },
      {
        name: 'value',
        type: 'string',
...
const inheritedReactRadioGroupApi: readonly ComponentApiProp[] = [
  {
    name: 'slot',
    type: 'string',
...
const inheritedNativeRadioGroupApi: readonly ComponentApiProp[] = [
  {
    name: 'hitSlop',
...
export const radioGroupApi = {
  react: {
    sections: reactRadioGroupApiSections,
    inheritedProps: inheritedReactRadioGroupApi,
  },
  'react-native': {
    sections: nativeRadioGroupApiSections,
    inheritedProps: inheritedNativeRadioGroupApi,
  },
} as const;
