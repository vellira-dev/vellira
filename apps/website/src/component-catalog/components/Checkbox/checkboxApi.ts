...
const reactCheckboxApiSections: readonly ComponentApiSection[] = [
  {
    name: 'Checkbox',
    props: [
      {
      ...
      },
      {
        name: 'description',
        type: 'ReactNode',
        description: 'Helper text rendered below the checkbox row.',
      },
      {
        name: 'icon',
        type: 'ReactNode',
        description: 'Icon rendered for the checked state.',
      },
      {
        name: 'indeterminateIcon',
        type: 'ReactNode',
        description: 'Icon rendered for the indeterminate state.',
      },
      {
        name: 'color',
      ...
      },
      {
        ...
        type: 'string',
        description: 'Extra CSS class for the clickable label wrapper.',
      },
      {
        name: 'checked',
        type: 'boolean',
      ...
      },
      {
        ...
        type: 'boolean',
        defaultValue: 'false',
        description: 'Displays and announces a mixed selection state.',
      },
      {
        name: 'error',
        type: 'string',
        description: 'Error message rendered for invalid state.',
      },
      {
        name: 'size',
        type: "'sm' | 'md' | 'lg'",
        defaultValue: "'md'",
        description: 'Controls checkbox indicator and label sizing.',
      },
      {
...
const nativeCheckboxApiSections: readonly ComponentApiSection[] = [
  {
    name: 'Checkbox',
    props: [
      {
      ...
      },
      {
        ...
        description: 'Extra style for the clickable wrapper.',
      },
      {
        name: 'checked',
        type: 'boolean',
...
const inheritedReactCheckboxApi: readonly ComponentApiProp[] = [
  {
    name: 'form',
    type: 'string',
  ...
  {
    name: 'autoCapitalize',
    type: '(string & {}) | "off" | "on" | "none" | "sentences" | "words" | "characters"',
    description: 'Forwarded React DOM prop.',
  },
  {
    name: 'autoFocus',
  ...
  {
    name: 'inputMode',
    type: "'search' | 'text' | 'email' | 'tel' | 'none' | 'url' | 'numeric' | 'decimal'",
    description:
  ...
  {
    name: 'aria-current',
    type: 'boolean | "time" | "step" | "true" | "false" | "page" | "location" | "date"',
    description:
...
const inheritedNativeCheckboxApi: readonly ComponentApiProp[] = [
  {
    name: 'children',
    type: 'React.ReactNode | ((state: PressableStateCallbackType) => React.ReactNode)',
    description:
...
export const checkboxApi = {
  react: {
    sections: reactCheckboxApiSections,
    inheritedProps: inheritedReactCheckboxApi,
  },
  'react-native': {
    sections: nativeCheckboxApiSections,
    inheritedProps: inheritedNativeCheckboxApi,
  },
} as const;
