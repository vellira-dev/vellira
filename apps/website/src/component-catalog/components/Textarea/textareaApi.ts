...
const reactTextareaApiSections: readonly ComponentApiSection[] = [
  {
    ...
    props: [
      ...
      },
      {
        name: 'description',
        type: 'string',
        description: 'Supporting text rendered with the field.',
      },
      {
        name: 'error',
        type: 'string',
...
const nativeTextareaApiSections: readonly ComponentApiSection[] = [
  {
    ...
    props: [
      ...
      },
      {
        name: 'inputStyle',
        type: 'TextStyle',
        description: 'Style applied to the native multiline TextInput.',
      },
      {
        name: 'label',
        type: 'string',
...
const inheritedReactTextareaApi: readonly ComponentApiProp[] = [
  ...
  },
  {
    ...
    type: 'ChangeEventHandler<HTMLTextAreaElement, Element>',
    description: 'Forwarded React DOM prop.',
  },
  {
    name: 'onBeforeInput',
  ...
  {
    name: 'onSubmit',
    type: 'SubmitEventHandler<HTMLTextAreaElement>',
    description: 'Forwarded React DOM prop.',
  },
  {
...
const inheritedNativeTextareaApi: readonly ComponentApiProp[] = [
  ...
  {
    name: 'autoComplete',
    type: "'2fa-app-otp' | 'additional-name' | 'address-line1' | 'address-line2' | 'birthdate-day' | 'birthdate-full' | 'birthdate-month' | 'birthdate-year' | 'cc-csc' | 'cc-exp' | 'cc-exp-day' | 'cc-exp-month' | 'cc-exp-year' | 'cc-number' | 'cc-name' | 'cc-given-name' | 'cc-middle-name' | 'cc-family-name' | 'cc-type' | 'country' | 'current-password' | 'email' | 'email-otp' | 'flight-confirmation-code' | 'flight-number' | 'family-name' | 'gender' | 'gift-card-number' | 'gift-card-pin' | 'given-name' | 'honorific-prefix' | 'honorific-suffix' | 'loyalty-account-number' | 'name' | 'name-family' | 'name-given' | 'name-middle' | 'name-middle-initial' | 'name-prefix' | 'name-suffix' | 'new-password' | 'nickname' | 'one-time-code' | 'organization' | 'organization-title' | 'password' | 'password-new' | 'postal-address' | 'postal-address-country' | 'postal-address-dependent-locality' | 'postal-address-extended' | 'postal-address-extended-postal-code' | 'postal-address-locality' | 'postal-address-region' | 'postal-address-unit' | 'postal-code' | 'promo-code' | 'street-address' | 'sms-otp' | 'tel' | 'tel-country-code' | 'tel-national' | 'tel-device' | 'upi-vpa' | 'url' | 'wifi-password' | 'username' | 'username-new' | 'off'",
    description:
  ...
  {
    name: 'inputMode',
    type: "'none' | 'email' | 'tel' | 'url' | 'numeric' | 'text' | 'decimal' | 'search'",
    description:
  ...
  {
    name: 'onChange',
    type: '((e: TextInputChangeEvent) => void)',
  ...
  {
    name: 'returnKeyType',
    type: "'none' | 'default' | 'search' | 'done' | 'go' | 'next' | 'send' | 'previous' | 'google' | 'join' | 'route' | 'yahoo' | 'emergency-call'",
    description:
  ...
  },
  {
    ...
    type: "'none' | 'text' | 'search' | 'button' | 'togglebutton' | 'link' | 'image' | 'keyboardkey' | 'adjustable' | 'imagebutton' | 'header' | 'summary' | 'alert' | 'checkbox' | 'combobox' | 'menu' | 'menubar' | 'menuitem' | 'progressbar' | 'radio' | 'radiogroup' | 'scrollbar' | 'spinbutton' | 'switch' | 'tab' | 'tabbar' | 'tablist' | 'timer' | 'list' | 'toolbar'",
    description:
