...
const reactFormFieldApiSections: readonly ComponentApiSection[] = [
  {
    name: 'FormField',
    props: [
      {
        name: 'id',
        type: 'string',
        description: 'Field id used as the control id. Generated when omitted.',
      },
      {
        name: 'label',
        type: 'ReactNode',
      ...
      },
      {
        name: 'description',
        type: 'ReactNode',
        description: 'Supporting text linked to compatible controls.',
      },
      {
        name: 'error',
        type: 'ReactNode',
      ...
      },
      {
        name: 'children',
        type: 'ReactNode',
        description: 'Control or custom field layout content.',
        required: true,
      },
      {
        name: 'bindControl',
      ...
      },
      {
        ...
        type: 'string',
        description: 'Class name applied to the description.',
      },
      {
        name: 'errorClassName',
        type: 'string',
        description: 'Class name applied to the error content.',
      },
      {
        name: 'messageClassName',
        type: 'string',
        description: 'Class name applied to the message content.',
      },
      {
        name: 'messageTone',
        type: "'neutral' | 'success' | 'warning' | 'danger'",
        defaultValue: "'neutral'",
        description: 'Visual tone for message. Error always uses danger tone.',
      },
      {
        name: 'messageLive',
        type: "'off' | 'polite'",
      ...
      },
      {
        ...
        type: "'top' | 'start'",
        defaultValue: "'top'",
        description: 'Label placement within the selected orientation.',
      },
      {
        name: 'size',
        type: "'sm' | 'md' | 'lg'",
        defaultValue: "'md'",
        description: 'Field size propagated to compatible child controls.',
      },
    ],
  },
];

const nativeFormFieldApiSections: readonly ComponentApiSection[] = [
  {
    name: 'FormField',
    props: [
      {
      ...
      },
      {
        name: 'error',
        type: 'ReactNode',
        description: 'Error content. Also implies invalid state.',
      },
      {
        name: 'message',
        type: 'ReactNode',
      ...
      },
      {
        ...
        description: 'Style for the root field container.',
      },
      {
        name: 'controlStyle',
        type: 'StyleProp<ViewStyle>',
        description: 'Style for the control wrapper.',
      },
      {
        name: 'labelStyle',
      ...
      },
      {
        name: 'errorStyle',
        type: 'StyleProp<TextStyle>',
        description: 'Style for the error content.',
      },
      {
        name: 'messageStyle',
        type: 'StyleProp<TextStyle>',
        description: 'Style for the message content.',
      },
      {
        name: 'messageTone',
        type: "'neutral' | 'success' | 'warning' | 'danger'",
...
const inheritedReactFormFieldApi: readonly ComponentApiProp[] = [
  {
    name: 'slot',
    type: 'string',
  ...
  {
    name: 'autoCapitalize',
    type: '"off" | (string & {}) | "none" | "on" | "sentences" | "words" | "characters"',
    description: 'Forwarded React DOM prop.',
  },
  {
    name: 'autoFocus',
...
const inheritedNativeFormFieldApi: readonly ComponentApiProp[] = [
  {
    name: 'hitSlop',
  ...
  },
  {
    ...
    type: "'none' | 'button' | 'togglebutton' | 'link' | 'search' | 'image' | 'keyboardkey' | 'text' | 'adjustable' | 'imagebutton' | 'header' | 'summary' | 'alert' | 'checkbox' | 'combobox' | 'menu' | 'menubar' | 'menuitem' | 'progressbar' | 'radio' | 'radiogroup' | 'scrollbar' | 'spinbutton' | 'switch' | 'tab' | 'tabbar' | 'tablist' | 'timer' | 'list' | 'toolbar'",
    description:
...
export const formFieldApi = {
  react: {
    sections: reactFormFieldApiSections,
    inheritedProps: inheritedReactFormFieldApi,
  },
  'react-native': {
    sections: nativeFormFieldApiSections,
    inheritedProps: inheritedNativeFormFieldApi,
  },
} as const;
